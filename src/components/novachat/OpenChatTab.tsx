...
const STORAGE_KEY = "novachat-openchat-history";
...
export function OpenChatTab({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="flex flex-col h-full">
      <header className="h-16 px-4 flex items-center gap-3 border-b border-border bg-card">
        ...
        <div className="size-10 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-700 text-white grid place-items-center">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {messages.length === 0 && (
            <div className="text-center py-16">
              <div className="size-16 rounded-2xl bg-emerald-500/15 text-emerald-600 grid place-items-center mx-auto mb-3">
                <Bot className="size-8" />
              </div>
              <h3 className="font-semibold text-lg">Chat with OpenChat AI</h3>
              <p className="text-sm text-muted-foreground mt-1">A second AI assistant powered by OpenAI.</p>
            </div>
          )}
